...
- (void)viewDidLoad {
    ...
    //这里使用bounds是为了适配那些高帅富iphone5的屏幕高度，要不我就直接写460或480(隐藏状态栏时的屏幕高度了，TT
    ...
    label.text = @"这是UISCrollView额外人非进口量的开发将进口量";
    ...
    background.contentSize = CGSizeMake(320, frame.size.height+400);//这里设置background 的contentSize（内容区）比它的frame高度高 100，
